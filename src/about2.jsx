const About2 = () => {
    return (
      ...
      >
        <div className="relative bg-rose-800 shadow-xl max-w-7xl flex flex-col md:flex-row items-center overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-10 text-center md:text-left">
            ...
            <a
              ...
              className="bg-white hover:bg-rose-200 text-rose-800 font-bold py-3 px-5 transition font-merriweather"
            >
              Afíliate
            </a>
          </div>
