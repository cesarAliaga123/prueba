const Hero = () => {
    return (
      ...
      >
        <div className="text-center bg-black bg-opacity-50 p-16 rounded-lg">
          ...
          <a
            href="/otra-pagina"
            className="bg-rose-800 hover:bg-rose-900 text-white font-bold py-3 px-4 font-merriweather text-2xl rounded"
          >
            Afíliate
          </a>
        </div>
